...
public class ControllerUtils {
    ...
    public static Member getCurrentMember(HttpServletRequest request) {
        ...
        } //This will set the password as null so that it won't be exposed to the user even if we send whole member as the response
        return member; //This member is associated with only for this user
    }
