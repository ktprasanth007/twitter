...
public class GenericDB<T> {
    ...
    public static boolean deleteRow(TableLike<?> table, Condition condition) {
        ...
        try {
            ...
            DSLContext create = DSL.using(conn, SQLDialect.POSTGRES);
            if (condition != null) {
                int x = create.delete(table.asTable()).where(condition).execute(); // here x represents no of rows that got deleted
                return true;
            }
        } catch (Exception e) {
            System.out.println(e);
    ...
    public boolean updateColumn(TableField<tech.codingclub.helix.tables.records.MemberRecord, String> x, String value, TableImpl<?> table, Condition condition) {
        Connection conn = null;
        try {
            conn = databaseConnectionPool.getConnection();
            ...
            if (condition == null) {
                create.update(table).set(x, value).execute();
            } else {
                create.update(table).
                        set(x, value).
    ...
    public boolean updateColumn(TableField<tech.codingclub.helix.tables.records.MemberRecord, Boolean> x, Boolean value, TableImpl<?> table, Condition condition) {
        Connection conn = null;
        try {
            conn = databaseConnectionPool.getConnection();
